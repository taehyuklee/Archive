...
// <![CDATA[
var colours=new Array("gray", "gray", "black", "gray", "gray"); // colours for top, right, bottom and left borders and background of bubbles
  ...
  if (bubby[i]) {
    ...
    if (bubby[i]>sdown && bubbx[i]>sleft && bubbx[i]<sleft+swide+bubbs[i]) {
	  if (Math.random()<bubbs[i]/shigh*2 && bubbs[i]++<8) {
		bubb[i].width=bubbs[i]-"3px";
		bubb[i].height=bubbs[i]-"3px";
	  }
